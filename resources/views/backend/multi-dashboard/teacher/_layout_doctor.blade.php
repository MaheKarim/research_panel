				...
				<div class="container-fluid">
					...
					<div class="row">
						<div class="col-md-5 col-lg-4 col-xl-3 theiaStickySidebar">
							...
							<!-- Profile Sidebar -->
							@include('backend.multi-dashboard.teacher._sidebar_doctor')
							<!-- /Profile Sidebar -->
                    ...
                    <table class="table">
                       <thead>
                         <tr>
                           <th scope="col">Student 1 Name</th>
                           <th scope="col">Student 2 Name</th>
                           <th scope="col">Student 3 Name</th>
                           <th scope="col">Research Topics</th>
                       ...
                       <tbody>
                        ...
                        @foreach ($bookings as $student)
                         <tr>
                           <td>{{ $student->student1_name }}</td>
                           <td>{{ $student->student2_name }}</td>
                           <td>{{ $student->student3_name }}</td>
